...
<head>
  ...
  <!-- CSS & OTHER LINK-RELS -->
  <link rel="stylesheet" href="<?php get_template_directory_uri() . '/css/main.css' ?>" type="text/css" media="all" />
  ...
  <?php 
	  ...
	  wp_enqueue_script('html5shiv', get_template_directory_uri() . '/js/vendor/html5-3.6-respond-1.1.0.min.js', '', '3.6', false);
